...
class Bdd {
    ...
    private static $login = "blondel";   // login utilisateur de la BDD
    private static $mdp = "S558U";         // mdp  utilisateur de la BDD
    private static $bd = "blondel_resto";          // nom de la BDD
